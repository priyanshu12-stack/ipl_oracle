...
export default function QuizCard({
  ...
  // Build streak dots from score (last 5)
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex flex-col items-center gap-2">
        ...
        >
          <span>
            <span style={{ color: "var(--team-color)", fontWeight: 600 }}>
              {score.correct}
            </span>
            {" / "}
            {score.total} correct
          ...
          {score.total > 0 && (
            <div className="flex gap-1">
              {streakDots.map((_, i) => {
                // We can't track per-answer history here without prop drilling,
                // so show green dots for correct ratio
                const greenCount = score.correct;
